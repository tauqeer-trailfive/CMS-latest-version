          ...
          <Grid container width={{ xs: "100%", xl: 800 }} spacing={2}>
            <Grid item xs={12} md={8}>
              <Typography
                ...
                fontWeight={"800"}
              >
                {translate("resources.projects.fieldGroups.editProject")}
              </Typography>
              ...
              <Box display={{ xs: "block", sm: "flex", width: "100%" }}>
                <Box flex={1} mr={{ xs: 0, sm: "0.5em" }}>
                  <TextInput source="mixdownVideo" fullWidth disabled />
                </Box>
                <Box flex={1} mr={{ xs: 0, sm: "0.5em" }}>
                  <TextInput
                    source="mixdownPath"
              ...
              <Box display={{ xs: "block", sm: "flex", width: "100%" }}>
                <Box flex={1} mr={{ xs: 0, sm: "0.5em" }}>
                  <TextInput source="mixdownAudio" fullWidth disabled />
                </Box>
              </Box>
              ...
              <ArrayInput source="tracks">
                <SimpleFormIterator disableReordering={true} fullWidth>
                  <ReferenceInput label="Tracks" source="id" reference="tracks">
                    <AutocompleteInput
                      optionText="id"
                      optionValue="id"
                      fullWidth
