...
const DailyActiveUsersChart = () => {
  const [option, setOption] = React.useState<any>(9);
      ...
      >
        ...
        <FormControl>
          <Select
            ...
            defaultValue={option}
          >
            <MenuItem value={3}>Past 3 day</MenuItem>
            <MenuItem value={5}>Past 5 day</MenuItem>
            <MenuItem value={7}>Past 7 day</MenuItem>
            <MenuItem value={9}>Past 9 day</MenuItem>
          </Select>
        </FormControl>
      </Box>
      <CardContent>
