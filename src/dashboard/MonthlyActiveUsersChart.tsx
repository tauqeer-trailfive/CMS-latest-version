      ...
      >
        ...
        <FormControl>
          <Select
            ...
            defaultValue={option}
          >
            <MenuItem value={30}>Past 1 Month</MenuItem>
            <MenuItem value={60}>Past 2 Months</MenuItem>
            <MenuItem value={90}>Past 3 Months</MenuItem>
            <MenuItem value={120}>Past 4 Months</MenuItem>
            <MenuItem value={150}>Past 5 Months</MenuItem>
            <MenuItem value={180}>Past 6 Months</MenuItem>
            <MenuItem value={210}>Past 7 Months</MenuItem>
            <MenuItem value={240}>Past 8 Months</MenuItem>
            <MenuItem value={280}>Past 9 Months</MenuItem>
            <MenuItem value={310}>Past 10 Months</MenuItem>
            <MenuItem value={340}>Past 11 Months</MenuItem>
