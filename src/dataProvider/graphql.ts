         ...
         return {
            ...
            variables: {
               filter: {
                  ...
                  ...(params.filter.email && {
                     email_contains: params.filter.email,
                  }),
                  ...(params.filter.role && {
         ...
         return {
            ...
            variables: {
               data: {
                  ...
                  audioCorePluginAllowUser:
                     params.data.audioCorePluginAllowUser,
         ...
         return {
            ...
            variables: {
               data: {
                  ...
                  createdBy: {
                     connect: { id: params.data.createdBy.id },
                  },
         ...
         return {
            ...
            variables: {
               data: {
                  ...
                  owner: {
                     connect: {
                        id: params.data.owner.id || currentUser,
                     },
                  },
         ...
         return {
            ...
            variables: {
               data: {
                  ...
                  category: categoriesConnectorInProjEdit(
                     AddpreDefine,
                     ccat,
                     pcat
                  ),
                  availableFrom: new Date(
                     params.data.availableFrom
                  ).toISOString(),
                  tracks: tracksConnectorOnEditProject(ct, pt),
                  genres: genreConnectorOnEditProject(cg, pg),
                  musicalInstruments: musicalInstrConnectorOnEditProject(
                     cmi,
                     pmi
                  ),
                  rating: params.data.rating,
