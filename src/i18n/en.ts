...
const customEnglishMessages: TranslationMessages = {
  ...
  resources: {
    ...
    groups: {
      name: "Group |||| Groups",
      amount: "1 Group |||| %{smart_count} Effects",
      relative_to_poster: "Group on poster",
      detail: "Group detail",
      action: {
        accept: "Accept",
        reject: "Reject",
      ...
      errors: {},
      notification: {
        approved_success: "Group approved",
        approved_error: "Error: Group not approved",
        rejected_success: "Group rejected",
        rejected_error: "Error: Group not rejected",
      },
    },
  },
};
